...
const updateCategories = async (req) => {
  ...
  // apa bila check true / data categories sudah ada maka kita tampilkan error bad request dengan
  if (check) throw new BadRequestError("kategori nama duplikat");
  ...
  // jika id result false / null maka akan  menampilkan error 'Tidak ada kategori dengan id' yang
  if (!result) throw new NotFoundError(`Tidak ada Kategori dengan id : ${id}`);
